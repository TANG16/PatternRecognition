function [test_accuracy, train_accuracy] = Q3NNgeneratedScript(X_merged, Y_merged, train_max_idx, test_max_idx, y_train, y_test, hiddenLayerSize, optimFunc, activFunc)
